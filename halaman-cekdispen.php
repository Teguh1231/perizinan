    ...
    <div class="page-container row">
      ...
      <div class="page-sidebar " id="main-menu">
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <ul>
            <li class="">
              <a href="#"> <i class="material-icons">view_stream</i> <span class="title">Pengajuan Dispensasi</span> </a>
            </li>
            <li class="active">
              <a href="#"> <i class="material-icons">playlist_add_check</i> <span class="title">Cek Dispensasi</span> </a>
            </li>
          <!-- END SIDEBAR MENU -->
        </div>
      </div>
            ...
            <div class="col-md-6">
              <div class="grid simple form-grid">
                <div class="grid-title no-border">
                  <h4>Cek<span class="semi-bold">Dispensasi</span></h4>
                </div>
                <div class="grid-body no-border">
                  <form action="#" method="post" id="form_traditional_validation" name="form_traditional_validation" role="form" autocomplete="off" class="validate">
                    <div class="form-group">
                      <label class="form-label">Masukan Nomor Dispensasi</label>
                      <input class="form-control" id="nodispen" name="nodispen" type="text" required>
                    </div>
                    <div class="form-actions">
                      <div class="pull-right">
                        <button class="btn btn-success btn-cons" type="submit"><i class="icon-ok"></i> Cek Dispen</button>
                      </div>
                    </div>
                  </form>
                </div>
